...
directories; raw certificate tables and entry metadata; and delay-import
...
`corpus:verify` builds all nine fixture families twice and runs all 43 tests listed
