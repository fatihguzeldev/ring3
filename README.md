...
`corpus:verify` builds all eight fixture families twice and runs the 37 real-file
...
descriptor and supported DLL-name tests. The link-only helper and generated PE
