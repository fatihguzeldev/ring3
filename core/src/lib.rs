...
pub use pe::{
    ...
    PeExportSelection, PeExportTarget, PeFileRange, PeFileRangeSource, PeHeaderBatch,
    PeHeaderBatchError, PeHeaderBatchLimits, PeHeaderError, PeHeaderPrefix, PeHeaders,
    ...
    lookup_pe_export_batch, parse_pe_base_relocation_blocks, parse_pe_certificate_entries,
