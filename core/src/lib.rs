...
pub use pe::{
    ...
    PeDebugDirectoryEntry, PeDebugDirectoryError, PeDebugDirectoryTable, PeDelayImportDescriptor,
    ...
    PeResourceRoot, PeResourceRootEntry, PeResourceRootError, PeResourceRootName,
    PeResourceRootNameError, PeResourceRootNameTable, PeRvaError, PeSection, PeSectionTable,
    PeTlsDirectory, PeTlsDirectoryError, parse_pe_base_relocation_blocks,
    ...
    parse_pe_load_config_prefix, parse_pe_resource_root, parse_pe_resource_root_names,
