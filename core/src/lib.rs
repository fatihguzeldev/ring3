...
pub use pe::{
    ...
    PeCertificateTable, PeClrDataDirectory, PeClrError, PeClrHeader, PeDataDirectory,
    ...
    PeDelayImportError, PeDelayImportExportBatch, PeDelayImportExportError, PeDelayImportLookup,
    ...
    PeExportSelection, PeExportTarget, PeFileRange, PeFileRangeSource, PeForwarderHop,
    ...
    PeHeaderBatchLimits, PeHeaderError, PeHeaderPrefix, PeHeaders, PeImportDescriptor,
    PeImportError, PeImportExportBatch, PeImportExportError, PeImportLookup, PeImportLookupEntry,
    PeImportLookupError, PeImportSymbol, PeKind, PeLoadConfigError, PeLoadConfigPrefix,
    PeOptionalHeader, PeResourceDataEntry, PeResourceDataEntryError, PeResourceDataEntryTable,
    ...
    decode_pe_forwarder_request, lookup_pe_delay_import_exports,
