...
pub use pe::{
    ...
    lookup_pe_delay_import_exports, lookup_pe_export, lookup_pe_export_batch,
    lookup_pe_import_exports, parse_pe_amd64_exception_functions, parse_pe_base_relocation_blocks,
