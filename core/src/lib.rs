...
pub use pe::{
    ...
    PeImportSymbol, PeKind, PeLoadConfigError, PeLoadConfigPrefix, PeOptionalHeader, PeRvaError,
    ...
    parse_pe_import_lookups, parse_pe_load_config_prefix, parse_pe_sections,
