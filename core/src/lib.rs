...
pub use pe::{
    ...
    PeRvaError, PeSection, PeSectionTable, PeTlsDirectory, PeTlsDirectoryError, lookup_pe_export,
    lookup_pe_export_batch, lookup_pe_import_exports, parse_pe_amd64_exception_functions,
