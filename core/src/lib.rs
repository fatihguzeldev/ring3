...
pub use pe::{
    PeBaseRelocationBlock, PeBaseRelocationError, PeCertificateError, PeCertificateTable,
    PeDataDirectory, PeDelayImportDescriptor, PeDelayImportError, PeDelayImportLookup,
    ...
    parse_pe_base_relocation_blocks, parse_pe_certificate_table, parse_pe_delay_import_descriptors,
