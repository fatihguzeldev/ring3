...
pub use pe::{
    ...
    PeExportQuery, PeExportSelection, PeExportTarget, PeFileRange, PeFileRangeSource,
    PeHeaderBatch, PeHeaderBatchError, PeHeaderBatchLimits, PeHeaderError, PeHeaderPrefix,
    PeHeaders, PeImportDescriptor, PeImportError, PeImportLookup, PeImportLookupEntry,
