...
pub use pe::{
    ...
    PeFileRange, PeFileRangeSource, PeHeaderBatch, PeHeaderBatchError, PeHeaderBatchLimits,
    PeHeaderError, PeHeaderPrefix, PeHeaders, PeImportDescriptor, PeImportError,
    PeImportExportBatch, PeImportExportError, PeImportLookup, PeImportLookupEntry,
