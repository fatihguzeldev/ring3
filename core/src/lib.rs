...
pub use pe::{
    ...
    PeResourceRoot, PeResourceRootEntry, PeResourceRootError, PeRvaError, PeSection,
    ...
    parse_pe_load_config_prefix, parse_pe_resource_root, parse_pe_sections, parse_pe_tls_directory,
