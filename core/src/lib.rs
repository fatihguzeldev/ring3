...
pub use pe::{
    ...
    PeSection, PeSectionTable, PeTlsDirectory, PeTlsDirectoryError,
    parse_pe_base_relocation_blocks, parse_pe_delay_import_descriptors,
    ...
    parse_pe_import_lookups, parse_pe_sections, parse_pe_tls_directory, resolve_pe_file_range,
};
