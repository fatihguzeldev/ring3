...
pub use pe::{
    ...
    PeCertificateEntryTable, PeCertificateError, PeCertificateTable, PeClrDataDirectory,
    PeClrError, PeClrHeader, PeDataDirectory, PeDebugDirectoryEntry, PeDebugDirectoryError,
    PeDebugDirectoryTable, PeDebugPayload, PeDebugPayloadError, PeDebugPayloadRange,
    PeDebugPayloadTable, PeDelayImportDescriptor, PeDelayImportError, PeDelayImportLookup,
    ...
    PeExportName, PeExportNameError, PeExportNameTable, PeExportTarget, PeFileRange,
    PeFileRangeSource, PeHeaderError, PeHeaderPrefix, PeHeaders, PeImportDescriptor, PeImportError,
    ...
    PeSectionTable, PeTlsDirectory, PeTlsDirectoryError, parse_pe_base_relocation_blocks,
