...
pub use pe::{
    ...
    PeImportLookupEntry, PeImportLookupError, PeImportLookupObservationError, PeImportLookupSource,
    PeImportSymbol, PeKind, PeLoadConfigError, PeLoadConfigPrefix, PeModuleEvidence,
    PeModuleEvidenceLimits, PeModuleOutputLimits, PeObservedImportLookup, PeOptionalHeader,
    PeOptionalHeaderEvidence, PeOwnedDelayImportLookup, PeOwnedDelayImportLookupTable,
    PeOwnedDelayImportName, PeOwnedDelayImportNameTable, PeOwnedExportAddressEntry,
    ...
    parse_pe_import_lookups_with_iat_fallback, parse_pe_load_config_prefix,
