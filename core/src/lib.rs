...
pub use pe::{
    ...
    PeFileRangeSource, PeHeaderBatch, PeHeaderBatchError, PeHeaderBatchLimits, PeHeaderError,
    PeHeaderPrefix, PeHeaders, PeImportDescriptor, PeImportError, PeImportLookup,
    PeImportLookupEntry, PeImportLookupError, PeImportSymbol, PeKind, PeLoadConfigError,
    PeLoadConfigPrefix, PeOptionalHeader, PeResourceDataEntry, PeResourceDataEntryError,
    ...
    PeTlsDirectoryError, parse_pe_base_relocation_blocks, parse_pe_certificate_entries,
    ...
    parse_pe_export_names, parse_pe_header_prefix, parse_pe_header_prefix_batch, parse_pe_headers,
