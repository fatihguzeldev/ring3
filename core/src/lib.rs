...
pub use pe::{
    ...
    PeExportSelection, PeExportTarget, PeFieldEvidence, PeFileRange, PeFileRangeSource, PeFlagBit,
    ...
    describe_pe_architecture_declarations, inspect_pe_declared_evidence,
