...
pub use pe::{
    ...
    PeLoadConfigPrefix, PeOptionalHeader, PeOptionalHeaderEvidence, PeOwnedDelayImportLookup,
    ...
    decode_pe_forwarder_request, describe_pe_architecture_declarations,
    inspect_pe_declared_evidence, inspect_pe_delay_imports, lookup_pe_delay_import_exports,
