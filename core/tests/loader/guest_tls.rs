use super::tls_executable;

use ring3_core::execution::{Process32, ProcessStop, Register32, StopReason};

#[test]
fn guest_tls_values_and_reuse_survive_single_step_resumption() {
    let bytes = tls_executable::pe32();
