use super::reverse_search_executable;

use ring3_core::execution::{Process32, ProcessStop, Register32, StopReason};

#[test]
fn reverse_search_cdecl_calls_match_whole_and_single_step_execution() {
    let bytes = reverse_search_executable::pe32();
    ...
    assert_eq!((instructions, calls), (10, 2));
