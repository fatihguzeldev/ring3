...
use dinput_device_cases::{DATA, DEVICE, KEYBOARD};
use ring3_core::execution::{
    Access, Cpu32, MemoryError, Permissions, Process32, ProcessStop, Register32, StopReason,
};

const ROOT_CREATE: u32 = 0x7000_0558;
const ROOT_QUERY: u32 = 0x7000_055c;
const ROOT_RELEASE: u32 = 0x7000_0564;
const CREATE: u32 = 0x7000_0568;
const QUERY: u32 = 0x7000_056c;
const ADD: u32 = 0x7000_0570;
const RELEASE: u32 = 0x7000_0574;
const PAGE: u32 = 0x7001_7000;
const STACK: u32 = 0x1000_ef00;
const CODE: u32 = 0x0040_1000;
const GUID: u32 = DATA + 64;
const IID: u32 = DATA + 80;
...
fn root(p: &mut Process32) -> u32 {
    assert_eq!(call(p, ROOT_CREATE, &[0x0040_0000, 0x700, DATA, 0]), 0);
    word(p, DATA)
}

fn create(p: &mut Process32, root: u32) -> u32 {
