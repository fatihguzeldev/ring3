...
#[path = "../../core/tests/support/dinput_acquire_cases.rs"]
...
#[path = "../../core/tests/support/dinput_mouse_cooperative_cases.rs"]
mod dinput_mouse_cooperative_cases;
#[path = "../../core/tests/support/dinput_mouse_event_cases.rs"]
...
fn execute_x87_integer_add() {
    use ring3_core::execution::{Cpu32, Register32, StopReason, load_pe32};
    let code = [
        0xdd, 0x05, 0x00, 0x22, 0x40, 0x00, 0xda, 0x05, 0x10, 0x22, 0x40, 0x00, 0xdf, 0xe0, 0xdd,
        0x1d, 0x20, 0x22, 0x40, 0x00,
    ];
    for (control, top, source, expected, status) in [
        (0x027f, 0.5_f64, i32::MIN, -2_147_483_647.5_f64, 0),
        (0x007f, 1.0, 16_777_217, 16_777_218.0, 0),
        (0x007f, 0.0, -16_777_219, -16_777_220.0, 0x220),
        (0x007f, -0.0, 0, 0.0, 0),
    ] {
        let mut image = load_pe32(&executable::pe32(&code), 16).unwrap();
...
#[path = "../../core/tests/support/file_read_cases.rs"]
mod file_read_cases;
#[path = "../../core/tests/support/on_demand_file_cases.rs"]
...
fn execute_thread_state() {
    ...
    for (api, args, error) in [
        ...
        (0x7000_0440, vec![0x7500_9900, 5], 1400),
        (
            0x7000_0260,
            vec![0x0040_0000, 0x0040_2300, 0x0040_2340],
            1411,
        ),
        (0x7000_0250, vec![0], 1404),
        (0x7000_00c0, vec![0x4000_1000], 1402),
        (0x7000_0254, vec![0, 0], 6),
    ] {
