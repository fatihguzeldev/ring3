...
for (const name of ["calls", "modules", "heap", "version", "critical-sections", "tls", "global-memory", "code-pages", "cpinfo", "messages", "clipboard-formats", "process-version", "metrics", "gdi", "colors", "brushes", "cursors", "cursor-position", "local-realloc"]) {
