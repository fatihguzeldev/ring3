...
for (const name of ["state", "fp-control", "initializers", "arguments", "memory", "exception-frame", "heap", "dllonexit", "reverse-search", "string-traversal", "string-duplicate", "buffer-compare", "code-page", "onexit", "cpp-allocation", "string-length", "string-copy", "character-search", "file-status", "buffer-copy", "locale-activity", "locale-metadata", "random", "float-to-integer", "type-names", "string-prefix", "case-comparison", "formatting", "lowercase", "remove", "string-append"]) {
  const cpp = name === "cpp-allocation" || name === "type-names";
