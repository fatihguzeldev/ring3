...
for (const name of ["state", "fp-control", "initializers", "arguments", "memory", "exception-frame", "heap", "dllonexit", "reverse-search", "string-traversal", "string-duplicate", "buffer-compare", "code-page", "onexit", "cpp-allocation", "string-length", "buffer-copy", "locale-activity", "locale-metadata"]) {
