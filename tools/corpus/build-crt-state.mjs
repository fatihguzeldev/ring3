...
for (const name of ["state", "fp-control", "initializers", "arguments", "memory", "exception-frame", "heap", "dllonexit", "reverse-search", "string-traversal", "string-duplicate", "buffer-compare", "code-page", "onexit", "cpp-allocation", "string-length", "string-copy", "character-search", "file-status", "buffer-copy", "locale-activity", "locale-metadata", "random", "float-to-integer", "type-names"]) {
