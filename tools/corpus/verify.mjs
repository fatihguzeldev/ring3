...
const families = [
  { name: "dependency-chain", build: buildDependencyChainFixtures, fixtures: {
    ...
    RING3_CHAIN_PE32_LEAF: "i386/Ring3Leaf.dll",
    RING3_CHAIN_PE32PLUS_EXE: "amd64/Chain.exe",
    RING3_CHAIN_PE32PLUS_MIDDLE: "amd64/Ring3Middle.dll",
    RING3_CHAIN_PE32PLUS_LEAF: "amd64/Ring3Leaf.dll",
  } },
