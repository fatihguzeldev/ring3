...
import { buildRelocationFixtures, contract } from "./build-relocations.mjs";
...
test("relocation CLI refuses extra arguments before creating a build directory", () => {
  ...
  const result = spawnSync(process.execPath, [fileURLToPath(new URL("./build-relocations.mjs", import.meta.url)), "extra"], { encoding: "utf8", timeout: 5000, maxBuffer: 1024 * 1024 });
